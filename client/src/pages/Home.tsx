...
export default function Home() {
    return (
        ...
        >
            ...
            <p>
                You can PM me through Discord (-Nero Yuki-#8444) if you want to
            ...
            <ul>
                ...
                <li>
                    Rian8337 - 180000rp (12.64$) in Steam Wallet - I can have
                    more game now owowo
                </li>
                <li>
                    quantumvortex - 14.00$ in Steam Items - Thanks map validator
                    for even more game owo
                </li>
