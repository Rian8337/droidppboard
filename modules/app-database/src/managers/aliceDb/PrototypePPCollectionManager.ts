 ...
 */
export class PrototypePPCollectionManager extends DatabaseCollectionManager<DatabasePrototypePP> {
     ...
     */
    searchPlayers(page: number, searchQuery?: string): Promise<DatabasePrototypePP[]> {
     ...
     */
    getFromUid(uid: number): Promise<DatabasePrototypePP | null> {
