 ...
 */
export class UserBindCollectionManager extends DatabaseCollectionManager<DatabaseUserBind> {
     ...
     */
    async searchPlayers(page: number, searchQuery?: string): Promise<DatabaseUserBind[]> {
     ...
     */
    getFromUid(uid: number): Promise<DatabaseUserBind | null> {
